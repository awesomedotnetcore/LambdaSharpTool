...
using MindTouch.LambdaSharp.Core.Registrations;
using Newtonsoft.Json;
using Xunit;
using Xunit.Abstractions;

namespace MindTouch.LambdaSharp.Core.ProcessLogEvents.Tests {
    ...
    public class ProgressLogEntryAsync {
        ...
        public void LambdaException() {
            _logic.ProgressLogEntryAsync(_owner, "Unable to load type 'MindTouch.LambdaSharp.Core.ProcessLogEvents.Function' from assembly 'ProcessLogEvents'.: LambdaException", "1539238963679").Wait();
            CommonErrorReportAsserts();
            _provider.ErrorReport.Message.Should().Be("Unable to load type 'MindTouch.LambdaSharp.Core.ProcessLogEvents.Function' from assembly 'ProcessLogEvents'.");
